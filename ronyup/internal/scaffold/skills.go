...
var skillCatalog = []SkillDef{
	...
	},
	{
		ID:               "go-testing",
		Name:             "Go Testing",
		Description:      "Table-driven testify tests, mandatory x/testkit repo integration tests, app unit tests",
		Category:         catGo,
		DefaultBackend:   true,
		DefaultFullstack: true,
	},
	...
	},
	{
		...
		Description:      "Bounded contexts, aggregates, value objects — maps to feature modules and internal/domain",
		Category:         catArchitecture,
		DefaultBackend:   true,
		DefaultFullstack: true,
	},
	{
		...
		Description:      "Deep modules, information hiding, no pass-through layers or leaky ports",
		Category:         catArchitecture,
		DefaultBackend:   true,
		DefaultFullstack: true,
	},
	{
		...
		Description:      "Storage, indexes, partitioning, isolation, idempotency — Postgres/Redis data design",
		Category:         catArchitecture,
		DefaultBackend:   false,
		DefaultFullstack: false,
	},
	{
		ID:               "writing-tests",
		Name:             "Writing Tests",
	...
	},
	{
		...
		Description:      "Google developer-docs style for READMEs, SRS/SDD prose, doc comments, changelogs",
		Category:         catWorkflow,
		DefaultBackend:   true,
		DefaultFullstack: true,
	},
