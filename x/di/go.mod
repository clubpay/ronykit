...
require (
	...
	github.com/clubpay/ronykit/x/datasource v0.3.9
...
require (
	...
	github.com/clubpay/ronykit/std/gateways/fasthttp v0.24.9 // indirect
	github.com/clubpay/ronykit/x/apidoc v0.3.9 // indirect
