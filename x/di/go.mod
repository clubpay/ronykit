...
require (
	...
	github.com/clubpay/ronykit/rony v0.26.4
	github.com/clubpay/ronykit/stub v0.26.4
	github.com/clubpay/ronykit/x/datasource v0.5.4
	github.com/clubpay/ronykit/x/rkit v0.5.4
	github.com/clubpay/ronykit/x/telemetry v0.5.4
