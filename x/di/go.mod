...
require (
	...
	github.com/clubpay/ronykit/x/datasource v0.4.0
...
require (
	...
	github.com/clubpay/ronykit/std/gateways/fasthttp v0.25.0 // indirect
	github.com/clubpay/ronykit/x/apidoc v0.4.0 // indirect
