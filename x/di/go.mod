...
require (
	...
	github.com/clubpay/ronykit/x/datasource v0.5.22
	github.com/clubpay/ronykit/x/rkit v0.5.22
	github.com/clubpay/ronykit/x/telemetry v0.5.22
...
require (
	...
	github.com/clubpay/ronykit/std/gateways/fasthttp v0.26.22 // indirect
	github.com/clubpay/ronykit/x/apidoc v0.5.22 // indirect
