...
require (
	github.com/clubpay/ronykit/flow v0.27.0
	github.com/clubpay/ronykit/kit v0.27.0
	github.com/clubpay/ronykit/std/clusters/p2pcluster v0.27.0
	github.com/clubpay/ronykit/std/clusters/rediscluster v0.27.0
	github.com/clubpay/ronykit/std/gateways/fasthttp v0.27.0
	github.com/clubpay/ronykit/std/gateways/fastws v0.27.0
...
require (
	...
	github.com/clubpay/ronykit/rony v0.27.0 // indirect
	github.com/clubpay/ronykit/x/batch v0.5.0 // indirect
	github.com/clubpay/ronykit/x/p v0.5.0 // indirect
	github.com/clubpay/ronykit/x/telemetry v0.6.0 // indirect
