...
require (
	github.com/clubpay/ronykit/flow v0.18.18
	github.com/clubpay/ronykit/kit v0.18.18
	github.com/clubpay/ronykit/std/clusters/p2pcluster v0.18.18
	github.com/clubpay/ronykit/std/clusters/rediscluster v0.18.18
	github.com/clubpay/ronykit/std/gateways/fasthttp v0.18.18
...
replace (
	google.golang.org/genproto v0.0.0-20190306203927-b5d61aea6440 => google.golang.org/genproto v0.0.0-20250115164207-1a7da9e5054f
)
