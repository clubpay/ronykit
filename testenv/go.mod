...
require (
	github.com/clubpay/ronykit/flow v0.25.9
	github.com/clubpay/ronykit/kit v0.25.9
	github.com/clubpay/ronykit/std/clusters/p2pcluster v0.25.9
	github.com/clubpay/ronykit/std/clusters/rediscluster v0.25.9
	github.com/clubpay/ronykit/std/gateways/fasthttp v0.25.9
	github.com/clubpay/ronykit/std/gateways/fastws v0.25.9
	github.com/clubpay/ronykit/stub v0.25.9
...
require (
	...
	github.com/clubpay/ronykit/x/batch v0.3.9 // indirect
	github.com/clubpay/ronykit/x/rkit v0.4.9 // indirect
	github.com/clubpay/ronykit/x/telemetry v0.4.9 // indirect
