...
require (
	github.com/clubpay/ronykit/flow v0.26.4
	github.com/clubpay/ronykit/kit v0.26.4
	github.com/clubpay/ronykit/std/clusters/p2pcluster v0.26.4
	github.com/clubpay/ronykit/std/clusters/rediscluster v0.26.4
	github.com/clubpay/ronykit/std/gateways/fasthttp v0.26.4
	github.com/clubpay/ronykit/std/gateways/fastws v0.26.4
	github.com/clubpay/ronykit/stub v0.26.4
...
require (
	...
	github.com/clubpay/ronykit/x/batch v0.4.4 // indirect
	github.com/clubpay/ronykit/x/rkit v0.5.4 // indirect
	github.com/clubpay/ronykit/x/telemetry v0.5.4 // indirect
